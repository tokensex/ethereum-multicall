...
import { ethers, ZeroAddress, JsonRpcProvider, Contract } from 'ethers';
...
var Multicall = /** @class */ (function () {
    ...
    Multicall.prototype.findOutputTypesFromAbi = function (abi, methodName) {
        var _a, _b;
        var contract = new ethers.Contract(ZeroAddress, abi);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!ethersProvider) {
                            ...
                            if (customProvider.nodeUrl) {
                                // @ts-ignore
                                ethersProvider = new JsonRpcProvider(customProvider.nodeUrl);
                            }
                            else {
                                // @ts-ignore
                    ...
                    case 1:
                        network = _a.sent();
                        contract = new Contract(this.getContractBasedOnNetwork(Number(network.chainId)), Multicall.ABI, ethersProvider);
                        overrideOptions = {};
                        if (options.blockNumber) {
